  ...
  <div class="mt-8 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
      ...
      <div class="flex flex-col">
        <label class="font-semibold mb-2 text-gray-700 dark:text-gray-200">Origin Airport</label>
        <select
          :value="origin"
        ...
        >
          ...
          <option v-for="orig in origins" :key="orig.code" :value="orig.code">
            {{ orig.code }} - {{ orig.name }} ({{ orig.flight_count }} flights)
          </option>
        </select>
      </div>
      ...
      <!-- Destination -->
      <div class="flex flex-col">
        <label class="font-semibold mb-2 text-gray-700 dark:text-gray-200">Destination Airport</label>
        <select
          :value="destination"
