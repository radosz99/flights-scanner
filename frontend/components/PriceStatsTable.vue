<template>
  <div v-if="chartData" class="mt-8">
    <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Price Statistics by Date</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div class="bg-gradient-to-br from-purple-600 to-purple-800 dark:from-purple-700 dark:to-purple-900 text-white p-6 rounded-lg shadow-md text-center">
        ...
        <div class="text-sm uppercase tracking-wide font-semibold opacity-90">Lowest Price</div>
      </div>
      <div class="bg-gradient-to-br from-purple-600 to-purple-800 dark:from-purple-700 dark:to-purple-900 text-white p-6 rounded-lg shadow-md text-center">
        <div class="text-3xl font-bold mb-2">{{ overallStats.maxPrice }}</div>
        <div class="text-sm uppercase tracking-wide font-semibold opacity-90">Highest Price</div>
      </div>
      <div class="bg-gradient-to-br from-purple-600 to-purple-800 dark:from-purple-700 dark:to-purple-900 text-white p-6 rounded-lg shadow-md text-center">
        <div class="text-3xl font-bold mb-2">{{ overallStats.avgPrice }}</div>
        <div class="text-sm uppercase tracking-wide font-semibold opacity-90">Average Price</div>
      </div>
    </div>
    ...
    <div class="overflow-x-auto mt-4">
      <table class="w-full border-collapse text-sm bg-white dark:bg-gray-800 rounded-lg shadow">
        <thead class="bg-gray-100 dark:bg-gray-700 border-b-2 border-gray-300 dark:border-gray-600">
          <tr>
            <th class="px-3 py-3 text-left font-semibold text-gray-700 dark:text-gray-200">Date</th>
            <th class="px-3 py-3 text-left font-semibold text-gray-700 dark:text-gray-200">Min Price</th>
            <th class="px-3 py-3 text-left font-semibold text-gray-700 dark:text-gray-200">Current Price</th>
            <th class="px-3 py-3 text-left font-semibold text-gray-700 dark:text-gray-200">Avg Price</th>
            <th class="px-3 py-3 text-left font-semibold text-gray-700 dark:text-gray-200">Max Price</th>
            <th class="px-3 py-3 text-left font-semibold text-gray-700 dark:text-gray-200">Flights</th>
          </tr>
        </thead>
        <tbody>
          <tr
